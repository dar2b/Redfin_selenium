...
#csv_file = open('reviews.csv', 'w', encoding='utf-8')         #save every 500 rows of data, if a problem w script 
...
while i>=0: 
	...
	colum = driver.find_elements_by_xpath('.//tr[@class=" PropertyHistoryEventRow"]')[i].text
